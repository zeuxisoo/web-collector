...
def create_stream(stream_id):
    ...
    bookmark = Bookmark.query.filter_by(type='stream', target_id=stream_id, user_id=g.user.id).first()
    ...
    return redirect(url_for('stream.image', result_id=stream.result_id, name=stream.result_name))
